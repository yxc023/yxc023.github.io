---
title: 在 windows 系统下使用 linux 命令行做开发
date: 2019-02-11
tags:
  - tools
  - windows
...
1. 在 menu:控制面板[程序 > 启用或关闭 windows 功能 ] 中, 勾选 `适用于linux 的 windows 子系统`
...
~~在 window 下, 可以使用 [cmder](http://cmder.net/) 来改善终端.~~

在windows下, 可以使用 [terminus](https://github.com/eugeny/terminus) 来改善终端.

上图:

![](/img/tools/linux-in-windows/screen.png)
