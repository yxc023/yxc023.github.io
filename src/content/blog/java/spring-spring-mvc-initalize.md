...
public static final String DEFAULT*CONFIG*LOCATION = "/WEB-INF/applicationContext.xml";

/** Default prefix for building a config location for a namespace */
public static final String DEFAULT*CONFIG*LOCATION_PREFIX = "/WEB-INF/";

/** Default suffix for building a config location for a namespace */
public static final String DEFAULT*CONFIG*LOCATION_SUFFIX = ".xml";	
```
